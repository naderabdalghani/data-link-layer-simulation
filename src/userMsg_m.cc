...
UserMsg_Base::~UserMsg_Base()
{
}

UserMsg_Base& UserMsg_Base::operator=(const UserMsg_Base& other)
{
...
Register_ClassDescriptor(UserMsgDescriptor)

UserMsgDescriptor::UserMsgDescriptor() : omnetpp::cClassDescriptor("UserMsg", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

UserMsgDescriptor::~UserMsgDescriptor()
{
    delete[] propertynames;
}

bool UserMsgDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<UserMsg_Base *>(obj)!=nullptr;
}

const char **UserMsgDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *UserMsgDescriptor::getProperty(const char *propertyname) const
{
...
const char *UserMsgDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *UserMsgDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int UserMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *UserMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string UserMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool UserMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *UserMsgDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *UserMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
